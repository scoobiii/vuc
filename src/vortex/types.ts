...
// Re-export ExecutionProof v2 and DAG provenance graph structures
export type {
  ExecutionProofV2,
  ParentRef,
  ParentRelation,
  ...
  GraphVerificationCheck,
} from './graph-verifier.js';
...
/**
 * Vortex Normative External Truth Contract
 */
...
export interface VortexExecutionResult<T = unknown> {
  success: boolean;
  external_effect: ExternalEffect;
  authenticated: boolean;
  execution_kind: 'llm' | 'capability';
  provider: string;
  data?: T;
  error?: {
    code: string;
